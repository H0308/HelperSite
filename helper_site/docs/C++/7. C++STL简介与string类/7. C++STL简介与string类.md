...
5. `string`类是`basic_string`模板类的一个实例，它使用char来实例化basic_string模板类，并用`char_traits`和`allocator`作为`basic_string`的默认参数(根于更多的模板信息请参考`basic_string`)
...
<img src="image\image1.png" align="left" width="400px" ><img src="image\image2.png" align="right" width="430px">
...
<img src="image\image3.png" align="left">
...
> 执行`reserve()`函数前：
>
> <img src="image\image4.png" align="left">
>
> 执行`reserve()`函数后：
>
> <img src="image\image5.png" align="left">
...
<img src="image\image6.png" align="left">
...
<img src="image\image7.png" align="left">
...
<img src="image\image8.png" align="left">
