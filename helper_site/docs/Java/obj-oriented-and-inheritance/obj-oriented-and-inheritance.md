...
不同于方法重载，方法重写需要满足函数名相同、返回值（或是被继承类的所有子类（也称为[协变](https://www.help-doc.top/C%2B%2B/20.%20C%2B%2B%E5%A4%9A%E6%80%81/20.%20C%2B%2B%E5%A4%9A%E6%80%81.html?h=%E5%8D%8F%E5%8F%98#_2)））和形参列表相同，并且方法重写的前提是继承，如果子类重写了父类方法，则子类优先访问重写后的父类方法，例如下面的代码
