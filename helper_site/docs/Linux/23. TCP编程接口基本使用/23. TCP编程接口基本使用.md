...
该接口的第一个参数表示当前需要作为传输的套接字，第二个参数表示等待中的客户端的最大个数。之所以会有第二个参数是因为一旦请求连接的客户端太多但是服务器又无法快速得做出响应就会导致用户一直处于等待连接状态从而造成不必要的损失，具体介绍见[理解Linux如何看待连接以及TCP全连接队列](#)。一般情况下第二个参数不建议设置比较大，而是因为应该根据实际情况决定，但是一定不能为0，本次大小定为8
...
但是，这样写还不足以解决问题，在[Linux进程间通信](https://www.help-doc.top/Linux/17.%20Linux%E8%BF%9B%E7%A8%8B%E9%97%B4%E9%80%9A%E4%BF%A1/1.%20%E8%BF%9B%E7%A8%8B%E9%97%B4%E9%80%9A%E4%BF%A1%E4%BB%8B%E7%BB%8D%E4%B8%8E%E5%8C%BF%E5%90%8D%E7%AE%A1%E9%81%93/1.%20%E8%BF%9B%E7%A8%8B%E9%97%B4%E9%80%9A%E4%BF%A1%E4%BB%8B%E7%BB%8D%E4%B8%8E%E5%8C%BF%E5%90%8D%E7%AE%A1%E9%81%93.html?h=%E8%BF%9B#_11)提到子进程会拷贝父进程描述符表，此时同样会导致文件描述符泄漏问题，所以父进程和子进程都需要关闭自己不需要的文件描述符：对于父进程来说，其需要关闭读写用的文件描述符，因为写入和读取交给了子进程；对于子进程来说，其需要关闭监听用的文件描述符，因为继续监听其他客户端的连接由父进程进行
