...
这就是在网络套接字部分实现的继承和多态，这一点在前面[操作系统管理System V标准中三种资源的方式](https://www.help-doc.top/Linux/com-process/com-system-v-resources/com-system-v-resources.html#system-v)也有类似的结构形式
