...
在[回溯基础练习](https://www.help-doc.top/algorithm/backtracking/backtracking-basic/backtracking-basic.html#_1)中已经大致了解到回溯解决的问题，并且在题目中也更深刻理解了前面在[回溯理论基础](https://www.help-doc.top/algorithm/backtracking/backtracking-concept/backtracking-concept.html#_6)提到的回溯法模板，但是这个模板只是为了便于理解回溯算法，并不能将所有题目都强行为了填充模板而限制了思考，所以为了从模板思路跳脱出来，需要考虑下面的练习
