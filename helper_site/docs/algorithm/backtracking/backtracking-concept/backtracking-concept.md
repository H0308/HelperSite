...
!!! note "排列和组合"
    ...
    **组合是不强调元素顺序的，排列是强调元素顺序**
    ...
    例如：{1, 2}和{2, 1}在组合上，就是同一个集合，因为不强调顺序，所以在求解组合相关的问题时，首先要考虑的就是从当前元素的下一个位置开始搜索从而去掉之前已经出现的类似情况，例如[力扣77.组合](https://www.help-doc.top/algorithm/backtracking/backtracking-basic/backtracking-basic.html#77)，部分题目可能说明可以出现重复元素，此时要结合前面的组合规则修改对应的逻辑，例如[力扣39.组合总和](https://www.help-doc.top/algorithm/backtracking/backtracking-basic/backtracking-basic.html#39)
