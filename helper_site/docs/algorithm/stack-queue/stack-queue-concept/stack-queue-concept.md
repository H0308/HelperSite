...
所以STL队列也不被归类为容器，而被归类为[容器适配器](https://www.help-doc.top/cpp/sim-stack-queue/sim-stack-queue.html#_1)

关于栈和队列的具体内容可以看[数据结构：栈部分](https://www.help-doc.top/data-structure/stack/stack.html)和[数据结构：队列部分](https://www.help-doc.top/data-structure/queue/queue.html)