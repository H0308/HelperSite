    ...
    <div class="main-content-area">
        ...
        <div class="side-section">
            ...
            <div class="content-card">
                ...
                <p>本网站PC端内容区的链接打开方式是打开预览窗口而非跳转到链接对应的网页，但是第三方链接可能存在无法开启的情况，遇到时可以在预览窗口中直接点击「在新标签页打开」的按钮。<strong>移动端还是直接跳转</strong></p>
            </div>
    ...
    <div class="copyright-section">
        <div class="content-card">
            ...
            <div class="copyright-info">
                <p>本博客所有文章除特别声明外，均采用<a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans">CC BY-NC-SA 4.0</a>许可协议</p>
